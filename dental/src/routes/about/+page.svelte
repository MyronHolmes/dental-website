	...
	<div class="container" data-aos="fade-up">
		...
		<div class="row text-center">
			...
			<div class="col-md-4 mb-4">
				...
				<h5>Top-Rated Experts</h5>
				<p>Led by highly trained dentists with years of experience.</p>
			</div>
			<div class="col-md-4 mb-4">
				<i class="fa fa-heartbeat fa-3x mb-3 text-primary"></i>
				<h5>Comfort-First Approach</h5>
				<p>We prioritize comfort, care, and a stress-free experience.</p>
			</div>
		</div>
	</div>
</section>
